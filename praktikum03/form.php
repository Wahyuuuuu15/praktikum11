            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input name="jenis" id="jenis_0" type="radio" class="custom-control-input" value="lk">
                        <label for="jenis_0" class="custom-control-label">Laki-Laki</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input name="jenis" id="jenis_1" type="radio" class="custom-control-input" value="pr">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <select id="studi" name="studi" class="custom-select">
                        ...
                        <option value="digital">Bisnis Digital</option>
                    </select>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-8">
                    ...
                    <div class="custom-control custom-checkbox custom-control-inline">
                        <input name="skill[]" id="skill[]_2" type="checkbox" class="custom-control-input" value="JAVA">
