...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Masukkan akun</p>
      ...
      <form action="admin.php" method="post">
        ...
        <div class="input-group mb-3">
          <input type="kata sandi" class="form-control" placeholder="Kata Sandi">
          <div class="input-group-append">
            <div class="input-group-text">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn btn-primary btn-block"><a href="admin.php"></a>Masuk</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
